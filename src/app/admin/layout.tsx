...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <main className="admin-palette mx-auto flex w-full max-w-[1440px] flex-col gap-4 px-4 md:px-8 xl:px-12" style={{ paddingTop: "calc(20px + env(safe-area-inset-top, 0px))", paddingBottom: 48 }}>
